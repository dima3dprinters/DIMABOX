...
#define lcd_implementation_drawmenu_setting_edit_float12_selected(row, pstr, pstr2, data, minValue, maxValue) lcd_implementation_drawmenu_setting_edit_generic(row, pstr, '>', ftostr12(*(data)))
#define lcd_implementation_drawmenu_setting_edit_float12(row, pstr, pstr2, data, minValue, maxValue) lcd_implementation_drawmenu_setting_edit_generic(row, pstr, ' ', ftostr12(*(data)))

...
// Define this to set a custom name for your generic Mendel,
 #define CUSTOM_MENDEL_NAME "DIMA BOX"
...
// 13 is 100k Hisens 3950  1% up to 300¡ãC for hotend "Simple ONE " & "Hotend "All In ONE"
...
// Valores PID para el hot-end de Recreus sin ventilador de capa
    //#define  DEFAULT_Kp 150
    //#define  DEFAULT_Ki 1.50
    //#define  DEFAULT_Kd 680

// Valores PID para el hot-end de Recreus con ventilador de capa
    #define  DEFAULT_Kp 21.69
    #define  DEFAULT_Ki 1.07
    #define  DEFAULT_Kd 110.16
...
//    You must specify the X & Y coordinates of all 3 points
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER 0.6 //Más valor aquí-> más pegado
...
#define HOMING_FEEDRATE {80*60, 80*60, 6*60, 0}  // set the homing speeds (mm/min)

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {160,160,12800.0/3.0,220}  // Pasos/mm para DIMA  con micropasos de 1/16
...
//DIMA 3D
#define ACTIVATE_ADVANCED 0 //1 = Activado el men¨² avanzado, 0 = desactivado
#define HYSTERESIS 0 //1 = Activado el control de hist¨¦resis, 0 = desactivado
...
#define FLEX_PREHEAT_HPB_TEMP 0
#define FLEX_PREHEAT_FAN_SPEED 0   // Insert Value between 0 and 255

#define MADERA_PREHEAT_HOTEND_TEMP 200
#define PVA_PREHEAT_HOTEND_TEMP 195

...
float menu_hysteresis_Z=Z_DEFAULT_HYSTERESIS_MM;
float menu_hysteresis_E=E_DEFAULT_HYSTERESIS_MM;


//===========================================================================

Hysteresis hysteresis( X_DEFAULT_HYSTERESIS_MM, Y_DEFAULT_HYSTERESIS_MM, Z_DEFAULT_HYSTERESIS_MM, E_DEFAULT_HYSTERESIS_MM );
...
void Hysteresis::InsertCorrection(const float &x, const float &y, const float &z, const float &e)
{
	...
	Set(menu_hysteresis_X,menu_hysteresis_Y,menu_hysteresis_Z,menu_hysteresis_E);
